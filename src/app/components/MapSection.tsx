...
const MapSection = () => {
  return (
    <section className=" flex justify-between bg-black border-t bg-gradient-to-t from-black to-[#121212]">
      <div className="flex justify-center items-center w-full flex-col gap-10">
        ...
        <Link
          ...
          passHref
        >
          <button className="border p-4 rounded-full justify-end hover:bg-slate-900">
            Get Directions
          </button>
        </Link>
      </div>
