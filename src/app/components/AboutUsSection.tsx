    ...
    >
      ...
      <div className=" grid grid-cols-2 p-20">
        <div className="  bg-black  bg-opacity-75  bottom-0 pb-10 w-full">
          <h1 className="text-7xl font-bold  mt-20 p-10">About us</h1>
        ...
        <div className=" bg-black bg-opacity-40 rounded-[40px] p-10 flex flex-col justify-center items-start w-full">
          <span className="text-6xl font-bold mb-6">Rated Top 1%</span>
          <ul className="reviews">
            <li className=" relative">
              <Link href="https://g.co/kgs/ERsKZsB" rel="noopener noreferrer">
