  ...
  return (
    <div className="page-details">
      ...
      <div className=" flex flex-col p-20 gap-10 mx-28">
        <span>
          At <span className=" font-bold">The Ohio Tint & Vinyl Company</span>,
          we're passionate about enhancing your driving experience through
          high-quality car and window tinting solutions. With years of
          experience in the industry, we have established ourselves as a trusted
          name in vehicle customization and protection.
        </span>
        <div>
          <h2>Our Mission</h2>
          <p>
        ...
        <div>
          ...
          <ul className=" flex flex-col gap-6">
            <li>
              <span className=" font-bold">Expertise</span>: Our team of skilled
            ...
            <li>
              <span className=" font-bold">Attention to Detail</span>: We
